      ...
      <div className="container px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {shortcuts.map((shortcut, index) => (
            <Card key={index} className="card-interactive group border-0 hover-lift">
              <CardHeader className="text-center pb-4">
                <div className="bg-gradient-primary p-4 rounded-xl w-fit mx-auto mb-4 group-hover:shadow-glow transition-all duration-300">
                  <shortcut.icon className="w-7 h-7 text-primary-foreground" />
                </div>
                <CardTitle className="text-lg font-mono glow-border px-4 py-2 rounded-lg group-hover:text-primary transition-colors">
                  {shortcut.keys}
                </CardTitle>
              </CardHeader>
        ...
        <div className="text-center glow-border rounded-2xl p-8 shadow-glow hover-lift">
          <div className="flex items-center justify-center gap-2 mb-4">
            <MessageSquare className="w-6 h-6 text-accent pulse-glow" />
            <h3 className="text-2xl font-semibold gradient-text">Manual Questions</h3>
          </div>
